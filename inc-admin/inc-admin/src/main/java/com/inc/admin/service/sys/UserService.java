...
public interface UserService {
	...
	Map jiaoshi(Map<String, Object> map);

	Map xuesheng(Map<String, Object> map);
    ...
    UserDO getusersByusername(String valueOf);

	UserDO getusersByEmail(String userName);

	/**
	 * 查询该老师下所有学生
	 */
	List<UserDO> findStudentById(Map<String, Object> map);
}
