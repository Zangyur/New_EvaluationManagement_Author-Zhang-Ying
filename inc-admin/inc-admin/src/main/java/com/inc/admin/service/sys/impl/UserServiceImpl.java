...
public class UserServiceImpl implements UserService {
	...
	@Override
	public Map<String, Object> jiaoshi(Map<String, Object> map) {
		Object name = map.get("name");
		if(name!=null && !name.equals("")){
			map.put("userId",name);
			map.put("username","%"+name+"%");
		...
		List<UserDO> userDOS = userMapper.countTeacher(map);
		Map<String,Object> res = new HashMap<>();
		res.put("count",userDOS.size());
		res.put("list",userMapper.jiaoshi(map));
		return res;
	}

	@Override
	public Map xuesheng(Map<String, Object> map) {
		Object name = map.get("name");
		if(name!=null && !name.equals("")){
			map.put("userId",name);
			map.put("username","%"+name+"%");
		...
		List<UserDO> userDOS = userMapper.countUser(map);
		Map<String,Object> result = new HashMap<>();
		result.put("count",userDOS.size());
		result.put("list",userMapper.xuesheng(map));
		return result;
	}
	@Override
	public List<UserDO> findStudentById(Map<String, Object> map) {
		List<UserDO> result = new ArrayList<>();
		List<Integer> ids = banjiDao.findClass(map.get("userId"));
		for (Integer id : ids) {
			Object name = map.get("name");
			if(name!=null && !name.equals("")){
				map.put("userId",name);
			...
			List<UserDO> xuesheng = userMapper.xuesheng(map);
			result.addAll(xuesheng);
		}
		return result;
	}
	@Override
	...
	@Override
	public UserDO getusersByusername(String username) {
		return userMapper.getByUserName(username);
	}

	@Override
	public UserDO getusersByEmail(String email) {
